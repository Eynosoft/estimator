      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="vertical-menu iconNone">
            ...
            <a href="<?php echo base_url('requests/requeststatus').'/'.'0'; ?>">Unassigned <span class="badge badge-danger" style="font-size: 15px;"><?php echo !empty($assign_unassign_total['unassigned_total']) ? $assign_unassign_total['unassigned_total'] : '0'; ?></span></a>

            <a href="<?php echo base_url('requests/requeststatus').'/'.'1'; ?>">Assigned <span class="badge badge-success" style="font-size: 15px;"><?php echo !empty($assign_unassign_total['assign_total']) ? $assign_unassign_total['assign_total'] : '0'; ?></span></a>

            <a href="#">Withdrawn <span class="badge badge-primary" style="font-size: 15px;">0</span></a>

            <a href="<?php echo base_url('requests/'); ?>"><strong>Total <span class="badge badge-primary" style="font-size: 17px;"><?php echo  !empty($assign_unassign_total['total']) ? $assign_unassign_total['total'] : '0'; ?></span></strong></a>
          ...
          <div class="table-responsive">
            ...
            <table class="table table-bordered" id="requestors" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                foreach ($assign_unassign as $rows) {
