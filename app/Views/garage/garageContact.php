        ...
        <div class="card-body">
          ...
          <div class="form-row">
            <div class="form-group col-md-12">
              ...
              <?php echo form_label('Owner', 'owner_name', $lblAttributes); ?>
              <?php echo form_input(array('type' => 'text', 'class' => 'form-control', 'id' => 'owner_name', 'name' => 'owner_name', 'placeholder' => 'Enter Owner Name', 'value' => '')); ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-12">
              ...
              <?php echo form_label('Reports Password', 'reports_password', $lblAttributes); ?>
              <?php echo form_input(array('type' => 'text', 'class' => 'form-control', 'id' => 'reports_password', 'name' => 'reports_password', 'placeholder' => 'Enter Reports Password', 'value' => '')); ?>
              <span class="noteText">Password used to protect the report generated.</span>
              <?php if (isset($validation)) { ?>
                <div class='alert alert-danger mt-2'>
