...
<ul class="navbar-nav mx-auto bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  <!-- Sidebar - Brand -->
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('Dashboard'); ?>">

    <div class="sidebar-brand-text mx-3" style="font-size: 15px;"><b>Estimation Program</b></div>
  ...
  <li class="nav-item">
    ...
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOnegarage" aria-expanded="true" aria-controls="collapseOne">
