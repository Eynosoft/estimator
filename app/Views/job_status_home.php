      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="vertical-menu iconNone">
            ...
            <a href="<?php echo base_url('Jobsestimation/jobstatus').'/'.'1'; ?>">Pending <span class="badge badge-primary" style="font-size: 15px;"><?php echo $jobs_status_count['pending']; ?></span></a>

            <a href="<?php echo base_url('Jobsestimation/jobstatus').'/'.'2'; ?>">In progress <span class="badge badge-success" style="font-size: 15px;"><?php echo $jobs_status_count['inprogress']; ?></span></a>

            <a href="<?php echo base_url('Jobsestimation/jobstatus').'/'.'3'; ?>">Completed <span class="badge badge-danger" style="font-size: 15px;"><?php echo $jobs_status_count['completed']; ?></span></a>

            <a href="<?php echo base_url('Jobsestimation/jobstatus').'/'.'4'; ?>">Finish <span class="badge badge-warning" style="font-size: 15px;">0</span></a>

            <a href="<?php echo base_url('Jobsestimation/'); ?>"><strong>Total <span class="badge badge-primary" style="font-size: 17px;"><?php echo $jobs_status_count['total_data']; ?></span></strong></a>
          ...
          <div class="table-responsive">
            ...
            <table class="table table-bordered" id="requestors_jobs" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                if (!empty($job_row_data)) {

                  foreach ($job_row_data as $row) {
